...
public class RuleMetaData extends SearchTextBased<RuleId> implements HasName {
    ...
    public RuleMetaData(RuleMetaData rule) {
        ...
        this.device_id=rule.getDevice_id();
        this.device_name=rule.getDevice_name();
        this.sensor_id=rule.getSensor_id();
        this.sensor_name=rule.getSensor_name();
        this.threshold_type=rule.getThreshold_type();
        this.upper_limit=rule.getUpper_limit();
        this.lower_limit=rule.getLower_limit();
        this.alarm_status=rule.getAlarm_status();
