...
public class ModelConstants {
    ...
    public static final String DEVICE_PROTOCOL_PROPERTY = "protocol";
    public static final String DEVICE_SENSOR_PROPERTY = "sensor";

    public static final String DEVICE_UPLOAD_TYPE_PROPERTY = "upload_type";
    public static final String DEVICE_UPLOAD_PERIOD_PROPERTY = "upload_period";
    public static final String DEVICE_SERIAL_NUMBER_PROPERTY = "serial_number";
    public static final String DEVICE_HARDWARE_ID_PROPERTY = "hardware_id";
    public static final String DEVICE_IP_PROPERTY = "ip";
    public static final String DEVICE_STATUS_PROPERTY = "status";
    public static final String DEVICE_ONLINE_PROPERTY = "online";
    ...
    public static final String ALARM_SENSOR_ID = "sensor_id";
    public static final String ALARM_SENSOR_NAME = "sensor_name";
    ...
    public static final String PLUGIN_DEVICE_ID = "device_id";
    public static final String PLUGIN_DEVICE_NAME = "device_name";
    ...
    public static final String RULE_DEVICE_ID = "device_id";
    public static final String RULE_DEVICE_NAME = "device_name";
    public static final String RULE_SENSOR_ID = "sensor_id";
    public static final String RULE_SENSOR_NAME = "sensor_name";
    public static final String RULE_THRESHOLD_TYPE = "threshold_type";
    public static final String RULE_UPPER_LIMIT = "upper_limit";
    public static final String RULE_LOWER_LIMIT = "lower_limit";
    public static final String RULE_ALARM_STATUS = "alarm_status";
    ...
    public static final String RULE_BY_DEVICE_ID = "rule_by_device_id";
    public static final String RULE_BY_SENSOR_ID = "rule_by_sensor_id";
