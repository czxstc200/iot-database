...
public final class AlarmEntity implements BaseEntity<Alarm> {
    ...
    @Column(name = ALARM_ORIGINATOR_NAME)
    private String originator_name;
    @Column(name = ALARM_SENSOR_ID)
    private String sensor_id;
    @Column(name = ALARM_SENSOR_NAME)
    ...
    public AlarmEntity(Alarm alarm) {
        ...
        this.originator_name = alarm.getOriginator_name();
        this.sensor_id = "test sensor id";
        this.sensor_name = "test sensor name";
    }
    ...
    public Alarm toData() {
        ...
        alarm.setOriginator_name(originator_name);
        alarm.setSensor_id(sensor_id);
        alarm.setSensor_name(sensor_name);
        return alarm;
    }
